...
import { LayoutDashboard, Users, Map, Store, BookOpen, BarChart3, Settings, UserCog, LogOut, LayoutGrid, CheckSquare } from "lucide-react";
...
const navItems = [
  ...
  { title: "Company-wide", url: "/kpi", icon: BarChart3 },
